...
$(INDEX_FILL_TARGETS) &: $(DATA_DIR) $(INDEX_TRAIN_TARGETS)
	sidecar-search index fill $(INDEXFLAGS) $(INDEXFILLFLAGS) $(DATA_DIR)
...
$(INDEX_TUNE_TARGETS) &: $(INDEX_TRAIN_TARGETS) | $(DATA_DIR)
	sidecar-search index tune $(INDEXFLAGS) $(INDEXTUNEFLAGS) $(DATA_DIR)
...
$(INDEX_TRAIN_TARGETS) &: | $(DATA_DIR)
	sidecar-search index train $(INDEXFLAGS) $(INDEXTRAINFLAGS) $(DATA_DIR)
